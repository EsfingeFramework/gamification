...
import net.sf.esfinge.gamification.guardian.auth.ranking.DenyRankingAndLevelAuthorizer;
import net.sf.esfinge.metadata.annotation.validator.NotNull;

@Retention(RUNTIME)
@Target(METHOD)
@AuthorizerClass(DenyRankingAndLevelAuthorizer.class)
public @interface DenyRankingAndLevel {
